...
import { useCreateRequestModal } from './useCreateRequest'
...
import {
    ...
    CreateRequestRelationDataValues,
    CreateRequestValues,
} from './libs'
...
export function CreateRequestModal({
    ...
    const onCreateButtonClick = async () => {
        const { newRequestData } = await CreateRequestValues(selectedPatient.id)
        ...
        const { newCreatedData: newConditionValues } =
            await CreateRequestRelationDataValues(
                'conditions',
